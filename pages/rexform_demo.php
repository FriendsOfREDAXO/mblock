...
if ('' == $func) {
    ...
    $select = array_merge($select, ['status']);
    ...
    $group = array_merge($group, [100, 200]);
    ...
    $fragment->setVar('title', ('edit' == $func) ? rex_i18n::msg('rex_form_mblock_demo_entries_edit') : rex_i18n::msg('rex_form_mblock_demo_entries_add'));
